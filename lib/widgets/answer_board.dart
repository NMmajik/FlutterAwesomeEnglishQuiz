      ...
      builder: (context, value, child) {
        return Column(
          ...
          children: [
            ...
            SizedBox(height: kSpaceBetweenAnsBox),
            AnswerButton(
                id: 1,
      ...
      child: OutlinedButton(
        ...
        style: ButtonStyle(
          ...
          backgroundColor: isSelected.value == id
              ? MaterialStateProperty.all(kAnswerButtonColorSelected)
              : MaterialStateProperty.all(isDarkMode
                  ? kAnswerButtonColorDark
                  : kAnswerButtonColorLight),
          ...
          side: isCorrectAns
              ? MaterialStateProperty.all(
                  BorderSide(
                      width: kBorderSizeAnsBox, color: Colors.greenAccent),
                )
              : null,
        ),
      ),
